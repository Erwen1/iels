...
INSERT INTO boxes (shelf_id, name, barcode, status) VALUES
  ((SELECT id FROM shelves WHERE storage_unit_id = (SELECT id FROM storage_units WHERE name = 'Armoire 1' AND room_id = (SELECT id FROM rooms WHERE name = 'Salle 101')) AND level = 1), 'Boîte 1', 'BOX001', 'available'),
  ((SELECT id FROM shelves WHERE storage_unit_id = (SELECT id FROM storage_units WHERE name = 'Armoire 1' AND room_id = (SELECT id FROM rooms WHERE name = 'Salle 101')) AND level = 1), 'Boîte 2', 'BOX002', 'available'),
  ((SELECT id FROM shelves WHERE storage_unit_id = (SELECT id FROM storage_units WHERE name = 'Armoire 1' AND room_id = (SELECT id FROM rooms WHERE name = 'Salle 101')) AND level = 2), 'Boîte 3', 'BOX003', 'in_use'),
  ((SELECT id FROM shelves WHERE storage_unit_id = (SELECT id FROM storage_units WHERE name = 'Armoire 2' AND room_id = (SELECT id FROM rooms WHERE name = 'Salle 101')) AND level = 1), 'Boîte 4', 'BOX004', 'available'),
